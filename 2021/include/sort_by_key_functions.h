...
inline float sort_by_key_STD_PAIR(std::vector<int> &inputkeys, std::vector<int> &inputdata){
    //--- Init ---//
    ...
    //  TRANSFORM the 2 vector to one std::pair vector --> keys_data
...
inline float sort_by_key_HELPER_INDICES_VECTOR(std::vector<int>& inputkeys, std::vector<int>& inputdata){
    //--- Init ---//
...
inline float sort_by_key_PAIRED_VECTOR_ITERATOR(std::vector<int> &inputkeys, std::vector<int> &inputdata){
...
inline float sort_by_key_BOOSTTUPLEIT(std::vector<int> &inputkeys, std::vector<int> &inputdata){
    // on CPU - one warning
    // on GPU - error
