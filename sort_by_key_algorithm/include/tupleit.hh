// a boost::tuple iterator, implemented by Anthony Williams  - https://pastebin.com/LFkTHdQk  

// 2020 12 01 Domonkos Abraham
//      Added default constructor for OwningRefTuple.
// -----------------------------------------------------------------
...
//     };
    ...
    public:
    // default //added by Domonkos Abraham
    OwningRefTuple()
    {}
    ...
    template<typename IterTuple>
    struct TupleIt: public detail::TupleItHelper<IterTuple>::IteratorType
    {
        private:
